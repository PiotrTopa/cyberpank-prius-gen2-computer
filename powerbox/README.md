...
|--------|------|-----------|----------------|
| BMP280 #1 | `0x77` (SDO high) | **Inside** the computer box, near the POCO — chassis air temperature | `bmp_t`, `bmp_p` |
| BMP280 #2 | `0x76` (SDO low) | **Outside** the box — cabin ambient reference | `bmp2_t`, `bmp2_p` |
